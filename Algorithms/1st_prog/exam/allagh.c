    ...
    long long int find_time(long long int a[], long long int high, long long int low, long int K, long int N){//gia K>1  
    ...
    long int find_examer(long long int a[], long int K,long int N,long long time){    
      long int i,h;  
      long int people=0;  
      long int before_him;  
      for(i=0; i<N; i++){  
    ...
    int main (int argc, char *argv[]){  
      ...
      if ( fscanf(fp,"%ld",&help)==1)  
       ...
       long long int a[N];// a: contains the times   
       long int i;  
      if ( fscanf(fp,"%lli",&help2)==1)  
           a[0]=help2 ;  
      else {  
