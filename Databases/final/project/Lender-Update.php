	<?php	
		...
		if ($LId==='' or $Name==='' or $Town==='' or $StreetName==='' or $StreetNumber==='' or $PoastalCode===''){
			header('Location:Lender-Update.html');
			exit;
		}
		
		$result = mysqli_query($con, "UPDATE lender SET Name='$Name', Town='$Town', StreetName='$StreetName', StreetNumber=$StreetNumber, PoastalCode=$PoastalCode 
		WHERE LId=$LId");
