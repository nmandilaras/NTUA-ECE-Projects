	<?php	
		...
		if ($Name==='' or $Town==='' or $StreetName==='' or $StreetNumber==='' or $PoastalCode===''){
			header('Location:Borrower-Insert.html');
			exit;
		}
		
		$result = mysqli_query($con, "INSERT INTO `borrower` (`Name`, `Town`, `StreetName`, `StreetNumber`, `PoastalCode`) 
									VALUES ('$Name', '$Town', '$StreetName', $StreetNumber, $PoastalCode)");
		if($result === FALSE) {
