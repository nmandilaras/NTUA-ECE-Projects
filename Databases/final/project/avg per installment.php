...
<body>
	...
	<div style="margin:auto;">
		...
		<h1 style="text-align:center;color:#77419b;font-family:Lucida Handwriting;color:darkred;"><strong>average repayment</strong></h1>
	
	</div>

<!--	<div style="margin:auto;">
		
		<h3><strong>"Calculate the average of all the installments."</strong></h3>
...
<?php
		...
		$result = mysqli_query($con, "SELECT ROUND(AVG(amount),2) FROM repayment;");
		if($result === FALSE) { 
		...
		echo "<tr>";
		echo "<td>";echo "<strong>";echo "Average Repayment";echo "</strong>";echo "</td>";
		echo "</tr>";
		
		while($row = mysqli_fetch_array($result)) {
		echo "<tr>";
		echo "<td>";echo $row['ROUND(AVG(amount),2)'];echo "</td>";
		echo "</tr>";
		}
		echo "</table>";
		mysqli_close($con);	
