	<?php	
		...
		if ($BId==='' or $DateofRequest===''){
			header('Location:Loanrequest-Insert.html');
			exit;
		}
		...
		$result = mysqli_query($con, "INSERT INTO `loanrequest` (`BId`, `DateofRequest`, `Deadline`, `Amount`, `PaybackPeriod`, `Description`, `Percentage`) VALUES
($BId, '$DateofRequest', '$Deadline', $Amount, $PaybackPeriod, '$Description', $Percentage)");
		if($result === FALSE) { 
