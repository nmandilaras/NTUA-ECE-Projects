...
line1 = ax1.plot(ipc_Axis, label="Noallocate", color="red",marker='x')
...
line2 = ax2.plot(mpki_Axis, label="Allocate", color="blue",marker='o')

lns = line1 + line2
labs = [l.get_label() for l in lns]

plt.title("Allovate vs NoAllocate")
