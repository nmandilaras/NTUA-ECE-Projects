...
## For nbit predictors
predictors_to_plot2 = [ "  Nbit","  Pentium","  Not-Taken","  BTFNT","  Local-4K","  Local-2K", "  Ghp-1","  Ghp-0.06","  Ghp-0.5","  Ghp-0.03","  Hd-Nbit-4K-4-Ghp", "  Hd-Nbit-4K-4-Local","  Hd-G"]

predictors_to_plot = [ "  Local-4K","  Local-2K", "  Ghp-1","  Ghp-0.5","  Hd-Nbit-4K-4-Ghp", "  Hd-Nbit-4K-4-Local","  Hd-G"]
...
name=sys.argv[1]
plt.savefig("L2_"+name+".png",bbox_inches="tight")
